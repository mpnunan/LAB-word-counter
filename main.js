...
const wordCounter = (value) => {
  ...
  if (value) {
    // COMPLETE THE LOGIC 
     let separateWords = value.split(" ");
    
    wordCount.innerHTML = `Word Count: ${separateWords.length}`; 
  } else if (!value) {
...
const toggleMode = () => {
  ...
  } else {document.getElementById("bg-switch").innerHTML = "Dark Mode"};
  return document.getElementById("bg-switch").innerHTML;
}
